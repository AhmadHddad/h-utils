...
export declare class HMap<K=string, V> extends Map<K,V> {
  clear(): void;
  delete(key: K): boolean;
  forEach(callbackfn: (value: V, key: K, map: HMap<K, V>) => void, thisArg?: any): void;
  filter: (callbackfn: (value: V, key: K, map: HMap<K,V>) => boolean) => this;
  getValuesArray(): [V];
  map(): (callbackfn: (value: V, key: K, map: HMap<K,V>) => any) => this;
  mapArray(): (callbackfn: (value: V, key: K, map: HMap<K,V>) => boolean) => any[];
